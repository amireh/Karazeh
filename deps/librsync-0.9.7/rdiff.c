 ...
 */
static rs_result rdiff_sig(const char* in_basis_file, const char* in_sig_file/*poptContext opcon*/)
{
    FILE            *basis_file, *sig_file;
    rs_stats_t      stats;
    rs_result       result;
    
    basis_file = rs_file_open(in_basis_file, "rb");
    sig_file = rs_file_open(in_sig_file, "wb");
...
static rs_result rdiff_delta(const char *in_sig_name, const char* in_new_file, const char* in_delta_file/*poptContext opcon*/)
{
    ...
    sig_name = in_sig_name;
    sig_file = rs_file_open(sig_name, "rb");
    new_file = rs_file_open(in_new_file, "rb");
    delta_file = rs_file_open(in_delta_file, "wb");
...
static rs_result rdiff_patch(const char* in_basis_name, const char* in_delta_file, const char* in_new_file/*poptContext opcon*/)
{
    ...
    //     return RS_SYNTAX_ERROR;
    // }
    basis_name = in_basis_name;
    basis_file = rs_file_open(basis_name, "rb");
    delta_file = rs_file_open(in_delta_file, "rb");
    new_file =   rs_file_open(in_new_file, "wb");
...
static rs_result rdiff_action(const char *argv[])
{
    const char      *action;
