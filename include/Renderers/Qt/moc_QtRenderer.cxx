...
**
** Created: Fri Jun 3 22:58:31 2011
...
// SIGNAL 2
void Pixy::QtRenderer::emitValidateComplete(bool _t1, const Version & _t2)
{
...
// SIGNAL 3
void Pixy::QtRenderer::emitPatchStarted(const Version & _t1)
{
...
// SIGNAL 5
void Pixy::QtRenderer::emitPatchFailed(std::string _t1, const Version & _t2)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
...
// SIGNAL 6
void Pixy::QtRenderer::emitPatchComplete(const Version & _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 7
void Pixy::QtRenderer::emitApplicationPatched(const Version & _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
